...
{
    public class RelatedPersonCreateVm : ValidationObject
    {
        ...
        {
            if (!EnumUtils.HasValue(RelationType))
            {
                throw new DomainException("RelationType invalid", ExceptionLevel.Error);
            }
